...
namespace ArticlesApp.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        {   
            Article article = db.Articles.Include("Category").Include("Comments") //Include => face Join(verifica daca are prin article acces la celalalt tabel(de ex prin colectia de comentarii)
                               .Where(art => art.Id == id)
                               .First(); //merge si .SingelOrDefault. !!!First!!! ia primul element din secventa
        ...
        {
            Article article = db.Articles.Find(id);//cauta in baza de date obiectul
