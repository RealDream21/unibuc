...
namespace ArticlesApp.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        public IActionResult Show([FromForm] Comment comment)
        {
            ...
            {
                Article art = db.Articles.Include("Category").Include("Comments").Where(art => art.Id == comment.ArticleId).First();  
                Console.WriteLine("Eroare la trimiterea comentariului");
                return View(art);
            }
        ...
        public IActionResult Edit(int id, Article requestArticle)
        {
            ...
            {
                Console.WriteLine("Eroare la editare articol");
